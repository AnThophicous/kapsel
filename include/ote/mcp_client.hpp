...
struct McpInstallRequest {
    ...
    std::string server_name = "kapsel";
};

std::string mcp_client_config_json(const std::filesystem::path& command_path, const std::filesystem::path& cwd, const std::string& server_name = "kapsel");
